...
LDLIBSOPTIONS=-L../../../../../langs/h3d/builds/lib64 -L../../../../../langs/msys64/mingw64/x86_64-w64-mingw32/lib -L../../../../../langs/msys64/mingw64/lib/glib-2.0 -L../../../../../langs/msys64/mingw64/lib -lwinpthread.dll -lglfw3.dll -lopengl32 -lglu32 -lgobject-2.0.dll -lgstapp-1.0.dll -lgstbase-1.0.dll -lgstreamer-1.0.dll -lgio-2.0.dll -lglib-2.0.dll -lgstvideo-1.0.dll -lH3DAPI.dll -lH3DUtil.dll -lHAPI.dll

# Build Targets
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/libx3dsphere_D.${CND_DLIB_EXT}

${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/libx3dsphere_D.${CND_DLIB_EXT}: ${OBJECTFILES}
	${MKDIR} -p ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}
	${LINK.cc} -o ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/libx3dsphere_D.${CND_DLIB_EXT} ${OBJECTFILES} ${LDLIBSOPTIONS} -shared

${OBJECTDIR}/GLFWWindow.o: GLFWWindow.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -DDLL_EXPORT -I../../../../../langs/h3d/h3dapi-2.3.0/include -I../../../../../langs/h3d/hapi-1.3.0/include -I../../../../../langs/h3d/h3dutil-1.3.0/include -I../../../../../langs/msys64/mingw64/x86_64-w64-mingw32/include -I../../../../../langs/msys64/mingw64/include/glib-2.0 -I../../../../../langs/msys64/mingw64/lib/glib-2.0/include -I../../../../../langs/msys64/mingw64/include/gdk-pixbuf-2.0 -I../../../../../langs/msys64/mingw64/include -I../../../../../langs/msys64/mingw64/include/gstreamer-1.0 -I../../msys64/mingw64/include/boost  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/GLFWWindow.o GLFWWindow.cpp
...
.clean-conf: ${CLEAN_SUBPROJECTS}
	...
	${RM} ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/libx3dsphere_D.${CND_DLIB_EXT}
